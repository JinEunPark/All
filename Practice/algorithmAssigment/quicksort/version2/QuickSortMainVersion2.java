...
public class QuickSortMainVersion2 {
    public static void main(String[]args)throws IOException {
        ...
        SortMethod sortMethod = new QuickSort(new SelectPivotRandomNumber());
        ...
        makeOutputFile.makeOutputFile("insertionSort - array size 32 reslut",
                list_32.toString(),
                new File("/Users/bagjin-eun/Desktop/javaProject/All/Practice/algorithmAssigment/outputfile/quicksort/version2/quicksortArray_32_result.txt"));
        makeOutputFile1.makeOutputFile("insertionSort - sorted_array size 32 reslut",
                list2_32_sorted.toString(),
                new File("/Users/bagjin-eun/Desktop/javaProject/All/Practice/algorithmAssigment/outputfile/quicksort/version2/quicksortArray_32_sorted_result.txt"));
        makeOutputFile2.makeOutputFile("insertionSort - array size 1024 reslut",
                list3_1024.toString(),
                new File("/Users/bagjin-eun/Desktop/javaProject/All/Practice/algorithmAssigment/outputfile/quicksort/version2/quicksortArray_1024_result.txt"));
        makeOutputFile3.makeOutputFile("time runtime-\n", "\narraysize-30: "+secDiffTime1+"\n"+"time diff-"+"arraysize-30-sorted: "+secDiffTime2+"\n"+"time diff-"+"arraysize-1024: "+secDiffTime3+"\n"+"compare function count: "+sortMethod.comCount,
                new File("/Users/bagjin-eun/Desktop/javaProject/All/Practice/algorithmAssigment/outputfile/quicksort/version2/timeReslt.txt"));

...
import algorithmAssigment.MakeInputFile;
...
public class InsertionMain {
    public static void main(String[] args) throws IOException {
        ...
        makeOutputFile.makeOutputFile("insertionSort - array size 32 reslut",
                list_32.toString(),
                new File("/Users/bagjin-eun/Desktop/javaProject/All/Practice/algorithmAssigment/outputfile/insertionsort/InsertionArray_32_result.txt"));
        makeOutputFile1.makeOutputFile("insertionSort - sorted_array size 32 reslut",
                list2_32_sorted.toString(),
                new File("/Users/bagjin-eun/Desktop/javaProject/All/Practice/algorithmAssigment/outputfile/insertionsort/InsertionArray_32_sorted_result.txt"));
        makeOutputFile2.makeOutputFile("insertionSort - array size 1024 reslut",
                list3_1024.toString(),
                new File("/Users/bagjin-eun/Desktop/javaProject/All/Practice/algorithmAssigment/outputfile/insertionsort/InsertionArray_1024_result.txt"));
        makeOutputFile3.makeOutputFile("time runtime-\n", "\narraysize-30: "+secDiffTime1+"\n"+"time diff-"+"arraysize-30-sorted: "+secDiffTime2+"\n"+"time diff-"+"arraysize-1024: "+secDiffTime3+"\n",
                new File("/Users/bagjin-eun/Desktop/javaProject/All/Practice/algorithmAssigment/outputfile/insertionsort/timeReslt.txt"));
